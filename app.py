# app.py – Kniha hostů Apartmán Tyršova | SKRYTÝ ADMIN V JEDNOM SOUBORU
...
<style>
    ...
    .admin-input {
        width: 200px; opacity: 0.5; font-size: 12px; color: #999;
    }
</style>
...
# Tajné pole – jen ty víš, že tam je! (šedé, malé, neviditelné pro klienta)
admin_input = st.text_input("", placeholder="Zadej tajný kód...", key="admin_trigger", type="password", help="Pro majitele – zadej heslo")

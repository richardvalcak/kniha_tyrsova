# app.py – Kniha hostů | JEDNODUCHÝ A BEZPEČNÝ | VERZE 7.0 | © 2025
...
# === PŘIPOJENÍ K GOOGLE SHEETS (bez hlavičky – už je ručně) ===
sheet = None
try:
...
# === FORMULÁŘ (jednoduchý, bez paměti) ===
with st.form("checkin", clear_on_submit=True):  # ← vymaže po chybě
